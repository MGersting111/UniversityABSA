...
df_cleaned = pd.read_csv("cleaned_thm_reviews.csv")

# Lade ABSA-Ausgabe (Review, Aspect, Sentiment, Cluster)
df_clustered = pd.read_csv("absa_reviews_with_clusters_thm.csv")
...
# Speichern
df_final.to_csv("full_absa_dataset_thm.csv", index=False, encoding="utf-8")
